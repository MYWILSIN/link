<?php 
    ...
    $domain = "https://urlw.000webhostapp.com/"; //like this: codingnepalweb.com/
    $host = "localhost";
    $user = "id19437540_willson"; //Database username
    $pass = "mPFyNi0Q1p&g7#W|"; //Database password
    $db = "id19437540_will"; //Database name
